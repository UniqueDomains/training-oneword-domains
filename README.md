# Available .TRAINING One-Word Domains (5,622,084)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C670%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-5%2C622%2C084%20domains-6f42c1">
...
> **Important:** this repository is a **public 8,670-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,084 domains** on the canonical page below.

**Public extract:** 8,670 rows · **Live catalog:** 5,622,084 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/training?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_training_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/training?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_training_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./training.csv">CSV</a> / <a href="./training.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_training_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_training_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .TRAINING search](https://unique.domains/domains/tld/training?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_training_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .TRAINING search](https://unique.domains/domains/tld/training?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_training_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./training.csv) or [Download JSON](./training.json)
...
- `training.csv` — public CSV extract (8,670 rows)
- `training.json` — public JSON extract (8,670 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,670-row public sample | 5,622,084 live domains                           |
...
| law.training     | premium   | $520      | $520          | 82             | 48     | 3      | namecheap        |
| mark.training    | available | $21.99    | $52.99        | 66             | 42     | 4      | name.com         |
| now.training     | resell    | —         | —             | 78             | 66     | 3      | Sav.com, LLC     |
| green.training   | premium   | $128.70   | $128.70       | 108            | 45     | 5      | namecheap        |
| order.training   | available | $21.99    | $52.99        | 78             | 41     | 5      | name.com         |
| code.training    | resell    | —         | —             | 72             | 64     | 4      | Dynadot Inc      |
| map.training     | premium   | $128.70   | $128.70       | 78             | 45     | 3      | namecheap        |
| eternal.training | available | $21.99    | $52.99        | 92             | 40     | 7      | name.com         |
...
| better.training  | resell    | —         | —             | 110            | 56     | 6      | Dynadot Inc      |
...
> Unique Domains. *Available .TRAINING One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
